...
public interface MiniJavaVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitVariableStatement(MiniJavaParser.VariableAssignmentStatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMethCall(MiniJavaParser.MethodCallExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFieldAccessExpression(MiniJavaParser.FieldAccessExpressionContext ctx);
	/**
